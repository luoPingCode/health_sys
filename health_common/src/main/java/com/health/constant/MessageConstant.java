...
public class MessageConstant {
    ...
    public static final String GET_MENU_SUCCESS = "获取用户菜单成功";
    public static final String GET_MENU_FAIL = "获取用户菜单失败";
    ...
    public static final String GET_ROLE_ERROR = "获取登陆用户角色失败";
    public static final String GET_ROLE_SUCCESS = "获取登陆用户角色成功";
    public static final String ADD_USER_FAIL = "新增用户失败";
    public static final String ADD_USER_SUCCESS = "新增用户成功";
    public static final String ADD_USER_HAS = "用户名已存在，请重新添加";
    public static final String EDIT_PASSWORD_FAIL = "修改密码失败";
    public static final String EDIT_PASSWORD_SUCCESS = "修改密码成功";
    public static final String GET_USER_FAIL = "获取用户失败";
    public static final String GET_USER_SUCCESS = "获取用户成功";
    ...
    public static final String EDIT_PERMISSION_FAIL = "修改权限数据失败";
    public static final String EDIT_PERMISSION_SUCCESS = "修改权限数据成功";
    ...
    public static final String ADD_MENU_FAIL = "新增权限菜单失败";
    public static final String ADD_MENU_SUCCESS = "新增权限菜单成功";
